...
<%
	Documento consulDoc = (Documento) request.getAttribute("procDetalhado");
...
<br>
<br>
<a href="controleDocumento?numProtocolo=<%=consulDoc.getNumProtocolo()%>&acao=encerrarProcesso">Encerrar Processo</a>
<br>
<br>
