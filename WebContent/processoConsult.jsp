...
<br>
<%
	Documento consultaDoc = (Documento) request.getAttribute("docmto");
...
<td><a href="controleDocumento?numProtocolo=<%=consultaDoc.getNumProtocolo()%>&acao=consultDetalh">Detalhar</a>
